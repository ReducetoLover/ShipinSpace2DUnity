...
namespace Reducer
{
  public class PositionContent : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      content.gameObject.GetComponent<RectTransform>().localPosition = new Vector2(transform.position.x, canvas.GetComponent<RectTransform>().sizeDelta.y * 1.1f - canvas.GetComponent<RectTransform>().sizeDelta.y);
